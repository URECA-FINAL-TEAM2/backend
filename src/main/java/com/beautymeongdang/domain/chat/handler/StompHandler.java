    ...
    public Message<?> preSend(Message<?> message, MessageChannel channel) {
        ...
        // SUBSCRIBE: 채팅방 입장 처리
            ...
            if (splits.length != 5) {
                ...
                throw new RuntimeException("INVALID_DESTINATION_FORMAT");
            }
            ...
            if (customerYnStr == null || userId == null) {
                ...
                throw new RuntimeException("SESSION_INFO_NOT_FOUND");
            }
            ...
            try {
                ...
                throw new RuntimeException("INVALID_CHAT_ID");
            }

            try {
                chatService.validateChatRoomAccess(chatId, Long.parseLong(userId), Boolean.valueOf(customerYnStr));
            } catch (Exception e) {
